...
Chrome Extensions: Competitive Companion, CF Analytics, Codeforces Lite(because I hate light mode), CPH Submit
VS Code Extensions: CPH(Competitive Programming Helper), C/C++ Debug
